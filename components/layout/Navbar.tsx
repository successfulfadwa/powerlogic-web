...
<>
<motion.header
className="fixed top-0 left-0 right-0 z-[500] px-4 lg"
initial={{ y: -100 }}
animate={{ y: 0 }}
transition={{ delay: 1.2, duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
>
<div
className="flex items-center justify-between px-5 lg"
style={{
height: scrolled ? '62px' : '76px',
background: scrolled ? 'rgba(5,6,10,0.75)' : 'rgba(5,6,10,0.35)',
...
<Image src="/brand/logo-main.png" alt="Powerlogic" width={160} height={48} className="h-10 w-auto object-contain" priority />
</Link>
</MagneticButton>
      {/* Desktop nav */}
      ...
      >
        ...
        >
          ...
          <div className="border-b" style={{ borderColor: 'var(--glass-border)' }}>
            <button
              type="button"
              className="w-full py-3 flex items-center justify-between text-base font-medium"
              style={{ color: 'var(--text-secondary)' }}
